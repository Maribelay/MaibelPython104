...
def generar_tablahechos(mes):
    print("==============bienvenidos a mi función====================")
    ...
    if not os.path.exists("modelosgenerados"):
       os.makedirs("modelosgenerados")
 

    # Guardar en un archivo Excel con varias hojas
    nombre_archivo_destino = "modelosgenerados/modelo_datos_ventas_" + str(mes)+ ".xlsx"
